...
| 15 | Python, file parsing, regex, JSON, CSV | `score_maturity.py`, `validate_crosswalk.py` | `npm test` (all green) | Script | "CSV → KPI JSON; regex ID validation" | Portfolio tooling |
